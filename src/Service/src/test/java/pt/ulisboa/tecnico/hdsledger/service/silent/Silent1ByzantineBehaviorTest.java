package pt.ulisboa.tecnico.hdsledger.service.silent;
...
class Silent1ByzantineBehaviorTest extends ByzantineBehaviorTest {

  public Silent1ByzantineBehaviorTest() {
    super("silent/1/nodes.json", "silent/1/clients.json");
  }
